...
const invalidAddresses = ["123", "002.001", "999.999.999.999", "qwerty.com", "266.266.266.266"]
const validAddresses = ["172.16.254.1:8000", "192.168.0.1", "11.22.33.44", "172.16.254.1:8000/code?as=123"]
